...
return(<div className="largeDiv"><div className="landingNav"><LandNav/></div>
...
<button className="get-started-btn" onClick={start}>Get Started</button>
...
<p ><span style={{fontWeight:"700"}}>Address:</span>Lorem ipsum dolor sit amet, consectetur</p>
<p ><span style={{fontWeight:"700"}}>Phone:</span>0699999999</p>
