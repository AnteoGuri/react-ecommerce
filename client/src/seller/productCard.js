...
<div className="card">
<div className="icons">
<DeleteIcon htmlColor="red" className="delete" fontSize="large" onClick={()=>{
     setToggle(true)
}}/>

<ModeEditIcon htmlColor="blue" className="edit" fontSize="large" onClick={()=>{
              seteditPopup(true)
       }}/>
</div>
...
<h5>Stock:{props.stock}</h5>
 ...
 <Deleteitem  deletePrompt={toggle} setDeletePrompt={setToggle} id={props.id}/>
<EditForm  trigger={editPopup} setTrigger={seteditPopup} id={props.id}
name={props.product_name} description={props.description} price={props.price}
stock={props.stock} image={props.image}/>
</div>
    )
}
