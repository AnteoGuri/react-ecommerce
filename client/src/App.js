  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route
          path="/seller/home"
          element={<Home id={id} active={"seller/home"} />}
        />
        <Route
          path="/seller/products"
          element={<Products id={id} active={"seller/products"} />}
        />
        <Route
          path="/seller/orders"
          element={<Sales id={id} active={"seller/orders"} />}
        />
        <Route
          path="/seller/orders"
          element={<Sales id={id} active={"seller/orders"} />}
        ...
        <Route
          path="/seller/history"
          element={<History id={id} active={"seller/history"} />}
        />
