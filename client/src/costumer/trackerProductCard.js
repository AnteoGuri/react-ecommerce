    ...
    <div>
      <div className="trackerCard">
        ...
        <div className="infoWrapper">
          ...
          {props.dateSent ? (
            <h5>
              Date sent:{props.dateSent.slice(0, props.dateSent.indexOf("T"))}
            </h5>
          ) : (
            <div></div>
          )}
